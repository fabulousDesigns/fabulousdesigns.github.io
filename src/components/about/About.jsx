    ...
    <section id="about">
      ...
      <div className="container about__container">
        ...
        <div className="about__content">
          ...
          <p>
            I'm a freelance Web Developer with speciaty in Front-End
            development,functionality,UX Design, and Search engine Optimization.
            I am outgoing, dedicated,and open-minded. I get across to people and
            adjust to changes easily. Its my belief that someone should work on
